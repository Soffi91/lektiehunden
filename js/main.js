...
function updateInfoboxHunden() {
  ...
  document.querySelector(".info-text h2").textContent = "HUNDEN";
  document.querySelector(".info-text .placeholder").textContent =
    "Du har valgt hunden!";
  document.querySelector("#efficiency").textContent =
    "Et forståeligt valg! - For den har jo faktisk spist dine lektier, og hvorfor lyve når det er sandheden?";
  document.querySelector("#requirement").textContent =
    "Effektivitet: Lav, da dine lærere nok ikke ville tage dig seriøst, og tænke at du spilder din egen og deres tid, eftersom de er blinde overfor problemet, og ikke er i stand til at se hunden.";
...
function updateInfoboxLektier() {
  ...
  document.querySelector(".info-text h2").textContent = "OM IGEN";
  document.querySelector(".info-text .placeholder").textContent =
    "Du har valgt at lave det igen!";
  document.querySelector("#efficiency").textContent =
    "Du gik med tredje løsning, som var at lave det igen.";
  document.querySelector("#requirement").textContent =
...
function updateInfoboxDreng() {
  ...
  document.querySelector(".info-text h2").textContent = "LYV";
  document.querySelector(".info-text .placeholder").textContent =
    "Du har valgt at lyve og sige at du slet ikke har lavet lektierne!";
  document.querySelector("#efficiency").textContent =
    "Hvis du overvejede hunden og tænkte den er der alligevel ikke nogen der tror på, så kan man jo lige så godt bare sige man ikke har lavet det.";

  document.querySelector("#requirement").textContent =
    "Effektivitet: Lav, da du virker som en der ikke tager din skole seriøst, og ikke laver dine ting Derudover risikerer man at tabe ansigt, og måske føle det er flovt at komme uforberedt i skole.";
